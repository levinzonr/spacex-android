...
import cz.levinzonr.spotistats.domain.interactors.GetSpaceXLaunchDetailsInteractor
...
class SpaceXLaunchDetailViewModel(
    id: String,
    private val getLaunchByIdInteractor: GetSpaceXLaunchDetailsInteractor
